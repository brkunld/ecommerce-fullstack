  ...
  const categories = await Promise.all([
    prisma.category.create({
      data: {
        ...
        description:
          "En yeni akıllı telefonlar, bilgisayarlar ve ses sistemleri.",
        image:
  ...
  const productsData = [
    {
      ...
      description:
        "Endüstri lideri gürültü engelleme, kristal netliğinde eller serbest arama ve 30 saat pil ömrü ile kusursuz ses deneyimi.",
      price: 14499.9,
      stock: 35,
      featured: true,
    ...
    },
    {
      ...
      description:
        "Profesyoneller için üst düzey performans. Liquid Retina XDR ekran ve 36 GB birleşik bellek ile sınırları zorlayın.",
      price: 119999.0,
      stock: 12,
      featured: true,
      categoryId: elektronik.id,
    ...
    },
    {
      ...
      description:
        "Özelleştirilebilir tuş anahtarları, alüminyum gövde ve dinamik RGB aydınlatma ile ultra düşük gecikmeli tepki süresi.",
      price: 3250.0,
      stock: 45,
      featured: false,
      categoryId: elektronik.id,
    ...
    },
    {
      ...
      description:
        "Safir kristal cam, hakiki İtalyan deri kordon ve Japon kuvars mekanizma ile zamansız bir zarafet.",
      price: 4890.0,
      stock: 28,
      featured: true,
      categoryId: moda.id,
    ...
    },
    {
      ...
      description:
        "Modern kesim, su itici kumaş ve sıcak tutan yün astarı ile sonbahar ve kış aylarının vazgeçilmezi.",
      price: 7650.0,
      stock: 18,
      featured: false,
      categoryId: moda.id,
    ...
    },
    {
      ...
      description:
        "Doğal meşe ahşap ve mat metal detaylar, kısılabilir sıcak LED ışık ile göz yormayan çalışma ortamı.",
      price: 1890.0,
      stock: 50,
      featured: true,
      categoryId: ev.id,
    ...
    },
    {
      ...
      description:
        "Usta zanaatkarlar tarafından elde şekillendirilmiş, bulaşık makinesinde yıkanabilir rustik espresso fincanları.",
      price: 1250.0,
      stock: 30,
      featured: false,
      categoryId: ev.id,
    ...
    },
    {
      ...
      description:
        "Çevre dostu TPE materyal, 6mm optimum kalınlık ve eklem koruyucu çift taraflı kaymaz doku.",
      price: 1450.0,
      stock: 60,
      featured: true,
      categoryId: spor.id,
    ...
    },
    {
      ...
      description:
        "Çift katmanlı vakumlu paslanmaz çelik, 24 saat soğuk ve 12 saat sıcak tutma performansı.",
      price: 890.0,
      stock: 85,
      featured: false,
      categoryId: spor.id,
